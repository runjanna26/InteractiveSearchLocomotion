...
class ESN_RR_Classification:
    ...
    def fit(self, X, y):
        ...
        # Move base matrices to PyTorch tensors on GPU/CPU device
        ...
        # 1. Process sequences on PyTorch/CUDA
        ...
        for i, cycle in enumerate(X):
            ...
            X_states_pt[i, :] = _jit_reservoir_loop(
                cycle_pt, self.W_in_pt, self.W_res_pt, self.leak_rate, self.n_res
            )
