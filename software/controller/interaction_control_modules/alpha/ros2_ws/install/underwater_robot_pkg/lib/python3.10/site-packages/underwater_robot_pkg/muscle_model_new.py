...
class MuscleModel:
    ...
    def calculate(self, pos_des, pos_fb, vel_fb):
        ...
        # Adaptive Equations
        self.dF = self.QF * (self.gen_track_error() - self.gen_adapt_scalar()* self.F)
        self.dK = self.QK * (self.gen_track_error() * self.gen_pos_error() - self.gen_adapt_scalar()* self.K)
        self.dD = self.QD * (self.gen_track_error() * self.gen_vel_error() - self.gen_adapt_scalar()* self.D)
